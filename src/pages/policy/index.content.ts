...
The token—which is useless to hackers—is stored in our system, not the card information, so your sensitive data is completely safe. This card CANNOT be accessed by our staff at checkout to pay for the appointment so please be sure to bring a form of payment!
